...
<div id="exception_error">
	...
	<div id="<?php echo $error_id ?>" class="content">
		<p><span class="file"><?php echo MI_Exceptions::debug_path($file) ?> [ <?php echo $line ?> ]</span></p>
		
		<?php echo MI_Exceptions::debug_source($file, $line) ?>
		
		<ol class="trace">
			<?php foreach (MI_Exceptions::trace($trace) as $i => $step): ?>
			<li>
				<p>
					<span class="file">
					<?php if ($step['file']): $source_id = $error_id.'source'.$i; ?>
						<a href="#<?php echo $source_id ?>" onclick="return koggle('<?php echo $source_id ?>')"><?php echo MI_Exceptions::debug_path($step['file']) ?> [ <?php echo $step['line'] ?> ]</a>
					<?php else: ?>
	...
	<?php $included = get_included_files() ?>
		...
		<div id="<?php echo $env_id ?>" class="collapsed">
			...
			<?php foreach ($included as $file): ?>
				<tr>
					<td><code><?php echo MI_Exceptions::debug_path($file) ?></code></td>
				</tr>
			<?php endforeach ?>
			</table>
		</div>
