...
/*
  ...
  |
 */
$config['log_threshold'] = $framework_ini['config']['log_threshold'];
...
/*
  ...
  |
 */
$config['cache_path'] = $framework_ini['config']['cache_path'];
...
/*
  ...
  |
 */
$config['encryption_key'] = md5($framework_ini['config']['sess_cookie_name']);
