...
<div class="content-box">
    <div class="content-box-header">
        <h3>Edit <?PHP echo $user['display_name']; ?></h3>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="username" id="username" class="text-input small-input" value="<?PHP echo $user['username']; ?>" maxlength="16" /></td>
                        </tr>
                        <tr>
                            <td width="125" class="right"><label for="display_name">Real Name:</label></td>
                            <td><input type="text" name="display_name" id="display_name" class="text-input medium-input" value="<?PHP echo $user['display_name']; ?>" /></td>
                        </tr>
                        <tr>
                            <td width="125" class="right"><label for="email">Email Address:</label></td>
                            <td><input type="text" name="email" id="email" class="text-input medium-input" value="<?PHP echo $user['email']; ?>" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="password" name="confirm_password" id="confirm_password" class="text-input small-input" value="" />
                                <small style="color: #999">&nbsp; Leave Password fields blank to keep old Passwords</small>
                            </td>
                        </tr>
                    </tbody>
                </table>
